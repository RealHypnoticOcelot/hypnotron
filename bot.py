...
bot = commands.Bot(command_prefix=commands.when_mentioned_or("h!"), case_insensitive=True, intents=intents, status=discord.Status.do_not_disturb, activity=discord.Game(name="h!"))
